      ...
      body: OnBoard(
        ...
        nextButton: OnBoardConsumer(
          builder: (context, ref, child) {
            ...
            return InkWell(
              onTap: () => state.isLastPage ? Navigator.push(context, MaterialPageRoute(builder: (context) => Home())) : _onNextTap(state),
              child: Container(
                width: 230,
                height: 40,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Flutter Onbord",style: TextStyle(fontSize: 15),),
      ),
      body: Center(
